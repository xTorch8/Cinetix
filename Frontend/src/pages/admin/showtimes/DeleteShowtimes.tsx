...
import DeleteShowtimesAPI from "../../../data/api/showtimes/DeleteShowtimesAPI";

const DeleteShowtimes = () : JSX.Element => {
    ...
    const submitHandler = async (event : SyntheticEvent) => {
        ...
        try {
            if (typeof userInformation !== "string") {
                ...
                const data      = await DeleteShowtimesAPI(userEmail, Number(id));  
                ...
                <Form submit = {submitHandler}>
                    <section className = "flex items-center">
                        <section className = "w-[95%]">
                            <h1 className = "text-2xl font-bold text-center"> Delete Showtimes </h1>    
                        </section>
